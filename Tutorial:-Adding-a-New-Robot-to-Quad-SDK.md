...
where `0-11` are actuator joints and ``jtoe0-3`` are fixed joints. All the rest are links. The leg is in the sequence of: front left, rear left, front right and rear right. 
