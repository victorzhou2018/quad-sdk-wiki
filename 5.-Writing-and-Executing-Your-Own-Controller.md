...
```
10. On the remote computer, launch your controller (you can do this from the TX2 but if you haven't put safety checks in and the connection fails you won't have a way to stop your :
```
cd ~
