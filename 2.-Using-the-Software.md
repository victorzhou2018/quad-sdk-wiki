...
### World Files
All the launch files listed above default to the flat world file but there are a number of other options, some of which are shown below. See [quad_simulator](https://github.com/robomechanics/quad-sdk/tree/main/quad_simulator/gazebo_scripts/worlds) for a full list of included world files, and [this tutorial](https://github.com/robomechanics/quad-sdk/wiki/Tutorial:-Creating-Custom-Terrain-Map-Files) to learn how to create your own world file. 
